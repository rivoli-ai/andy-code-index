...
public class TaskQueueServiceTests
{
    ...
    [InlineData(TaskOperation.ExtractSnippets, TaskOperation.ExtractDocumentText)]
    [InlineData(TaskOperation.ExtractDocumentText, TaskOperation.ExtractDependencies)]
